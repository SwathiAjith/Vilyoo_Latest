...
<h2><?php _e( 'Update account to Artist', 'dokan' ); ?></h2>
<form method="post" action="">
    ...
    <div class="dokan-become-seller">
        ...
        <input type="submit" class="dokan-btn dokan-btn-default" name="dokan_migration" value="<?php _e( 'Become an Artist', 'dokan' ); ?>" />
        </p>
    </div>
</form>