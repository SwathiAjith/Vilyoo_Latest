...
-->
				...
				<div id="home-latest-workshops">
					...
					<div class="clearfix"></div>
					<div class="white-bg col-md-12 shadow-it">
						<?php echo do_shortcode( '[product_category per_page="4" columns="4" category="diy-kits,workshops" orderby="date" order="DESC"]' ); ?>
						<p class="text-center">
							<a href="<?php echo get_site_url()?>/category/workshops" class="btn hero-btn btn-shop-all">More...</a>
						</p>
					</div>
				</div>
