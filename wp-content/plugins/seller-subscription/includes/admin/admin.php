    ...
    function add_new_setting_field_admin_panael( $settings_fields ) {
        ...
        $settings_fields['dokan_product_subscription'] = array(
            ...
            array(
                ...
                'desc'  => __( 'Enable product subscription for seller', 'dps' ),
                'type'  => 'checkbox'
            ),
            array(
                'name'  => 'notify_by_email',
                'label' => __( 'Enable Email Notification', 'dps' ),
                'desc'  => __( 'Enable notification by email for seller during end of the package expiration', 'dps' ),
                'type'  => 'checkbox'
            ),
            array(
                'name'    => 'no_of_days_before_mail',
                'label'   => __( 'No. of Days', 'dps' ),
                'desc'    => __( 'How many days befor email will be send to seller', 'dps' ),
                'type'    => 'text',
                'default' => '2'
            ),
            array(
                ...
                'desc'    => __( 'Product status when seller pack validity will be ended', 'dps' ),
                'type'    => 'select',
                'default' => '2',
                'options' => array(
            ...
            array(
                ...
                'desc'  => __( 'Enter body text for email nitification', 'dps' ),
                'type'  => 'textarea'
            )
        );
