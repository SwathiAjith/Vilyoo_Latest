...
?>
<div class="product-edit-sidebar-fixed">
    <div class="update-button-wrap">
        <input type="submit" id="update_product" name="update_product" class="dokan-btn btn-danger dokan-btn-lg" value="<?php esc_attr_e( 'Update Product', 'dokan' ); ?>"/>
    </div>
