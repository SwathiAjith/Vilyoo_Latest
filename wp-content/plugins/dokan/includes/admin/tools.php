<div class="wrap">
    <h2><?php _e( 'Vilyoo Tools', 'dokan' ); ?></h2>
    ...
    <div class="metabox-holder">
        <div class="postbox">
            ...
            <div class="inside">
                ...
                <a class="button button-primary" href="<?php echo wp_nonce_url( add_query_arg( array( 'dokan_action' => 'dokan_install_pages' ), 'admin.php?page=dokan-tools' ), 'dokan-tools-action' ); ?>"><?php _e( 'Install Required Pages', 'dokan' ); ?></a>
            </div>
        </div>
        ...
        <div class="postbox">
            ...
            <div class="inside">
                <p><?php _e( 'This tool will delete all orders from the Vilyoo\'s sync table and re-build it.', 'dokan' ); ?></p>
