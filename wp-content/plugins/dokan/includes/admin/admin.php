...
class Dokan_Admin_Settings {
    ...
    function admin_menu() {
        ...
        $dashboard = add_menu_page( __( 'Vilyoo', 'dokan' ), __( 'Vilyoo', 'dokan' ), $capability, 'dokan', array($this, 'dashboard'), 'dashicons-vault', $menu_position );
        add_submenu_page( 'dokan', __( 'Vilyoo Dashboard', 'dokan' ), __( 'Dashboard', 'dokan' ), $capability, 'dokan', array($this, 'dashboard') );
    ...
    public function update_notice() {
        ...
        <div id="message" class="updated">
            <p><?php _e( '<strong>Data Update Required</strong> &#8211; We need to update your install to the latest version', 'dokan' ); ?></p>
