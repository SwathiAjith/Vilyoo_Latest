...
"function" != typeof window.wpb_prepare_tab_content && (window.wpb_prepare_tab_content = function(event, ui) {
	...
	/*
		...
		On Date: 17 March, 2016
		Purpose: To set blog post title length: 43,
				 To set blog post description length: 220,
				 To set [...] if text length exceeds the limit
	*/
	setTimeout(setBlogText, 2000);
	
	function setBlogText(){
		$(".group-blog .vc_gitem-post-data-source-post_title").each(function(){
			var hrefval	=	$(this).find("a").attr("href");
			var title = $(this).text();
			var newstring = cutString(title, 43);
			if(newstring != "" && typeof newstring != "undefined") {
				$(this).html('<p style="font-size: 20px;color: #8c2864;text-align: left"> <a href="'+ hrefval +'" class="vc_gitem-link" title="' +title+ '">' + newstring + "</a> </p>");
			}
		});
		
		$(".group-blog .vc_gitem-post-data-source-post_excerpt").each(function(){
			var desc = $(this).text();
			var newstringDesc = cutString(desc, 220);
			if(newstringDesc != "" && typeof newstringDesc != "undefined") {
				$(this).html("<p>" + newstringDesc + "</p>");
			}
		});
	}
	
	function cutString(title,limit){
     	var text = title;         
	 	var charsToCutTo = limit;
        ...
        if(text.length>charsToCutTo){
			...
			var spacesCnt	= charsToCutTo - text.length;
			if(spacesCnt > 0) {
				var strShort = text;
				for(k = 0; k < spacesCnt; k++){
					strShort += "&nbsp;";
				}
			}
			return strShort;
